            ...
            <div class="history">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>2/6/2026</td>
                        <td> Moses Agada</td>
                        <td> Mosesag@gmail.com</td>
                        <td> Sick</td>
                        <td>
                            <ul>
                                <li><a href="#" class="accept disable">Accepted</a></li>
                                <li><a href="#" class=" accepted">Declined</a></li>
                    ...
                    <tr>
                        <td>2</td>
                        <td>1/6/2026</td>
                        <td> Miracle Daniel</td>
                        <td> Mimid21@gmail.com</td>
                        <td> Visitation</td>
                        <td>
                            <ul>
                                <li><a href="#" class="accept accepted">Accepted</a></li>
                                <li><a href="#" class="decline disable">Declined</a></li>
                                <li><a href="#" class="ellipse">&hellip;</a></li>
                            </ul>
                        </td>
                    </tr>
