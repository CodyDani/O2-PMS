        ...
        <div class="card-hold">
            <div class="card-1">
                <div class="card-1-text">
                    <h1>Welcome</h1>
                    <p><strong>to the 02 Permission Management System</strong> <br>
                        Submit your absence requests, track your permission history, and stay updated on your approval
            ...
            <div class="card-2">
                <p>Continue as an...</p>
                <div class="admin">
                    <a href="login.php?role=admin"><button>Admin</button></a>
                </div>
                <div class="admin">
                    <a href="login.php?role=intern"><button>Intern</button></a>
                </div>
            </div>
